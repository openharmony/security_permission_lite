...
OHOS::sptr<PermissionReminderInfo> PermissionReminderInfo::Unmarshalling(Parcel &in)
{
    PERMISSION_LOG_INFO(LABEL, "%{public}s called", __func__);
    OHOS::sptr<PermissionReminderInfo> permReminderInfo = new PermissionReminderInfo();
