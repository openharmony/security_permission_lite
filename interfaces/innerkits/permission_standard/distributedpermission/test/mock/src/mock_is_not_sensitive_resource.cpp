...
void RequestRemotePermission::GrantSensitivePermissionToRemoteApp(const std::string &permission,
...
bool RequestRemotePermission::HaveSensitivePermissionToRequest(const std::string deviceId, const int pid, const int uid,
