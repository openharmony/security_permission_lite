...
const std::string g_EVENT_REQU_FIRST = "requ_com_ohos_dpmsst_appkit_first";
const std::string g_EVENT_RESP_FIRST = "resp_com_ohos_dpmsst_appkit_first";
const std::string g_EVENT_RESP_FIRST_LIFECYCLE = "resp_com_ohos_dpmsst_appkit_first_lifecycle";
const std::string g_EVENT_RESP_FIRST_LIFECYCLE_CALLBACK = "resp_com_ohos_dpmsst_appkit_first_lifecycle_callbacks";
const std::string g_EVENT_RESP_FIRST_LIFECYCLE_OBSERVER = "resp_com_ohos_dpmsst_appkit_first_lifecycle_observer";
const std::string g_EVENT_RESP_FIRST_LIFECYCLE_OBSERVER2 = "resp_com_ohos_dpmsst_appkit_first_lifecycle_observer2";
const std::string g_EVENT_RESP_FIRST_ON_ABILITY_RESULT = "resp_com_ohos_dpmsst_appkit_first_onabilityresult";
const std::string g_EVENT_RESP_FIRST_ON_BACK_PRESSED = "resp_com_ohos_dpmsst_appkit_first_onbackpressed";
const std::string g_EVENT_RESP_FIRST_ON_NEW_WANT = "resp_com_ohos_dpmsst_appkit_first_onnewwant";
const std::string g_EVENT_REQU_FIRSTB = "requ_com_ohos_dpmsst_appkit_firstb";
const std::string g_EVENT_RESP_FIRSTB = "resp_com_ohos_dpmsst_appkit_firstb";
const std::string g_EVENT_RESP_FIRSTB_LIFECYCLE = "resp_com_ohos_dpmsst_appkit_firstb_lifecycle";
const std::string g_EVENT_REQU_SECOND = "requ_com_ohos_dpmsst_appkit_second";
const std::string g_EVENT_RESP_SECOND = "resp_com_ohos_dpmsst_appkit_second";
const std::string g_EVENT_RESP_SECOND_LIFECYCLE = "resp_com_ohos_dpmsst_appkit_second_lifecycle";
const std::string g_EVENT_RESP_SECOND_ABILITY_CONTEXT = "resp_com_ohos_dpmsst_appkit_secondability_ability_context";
const std::string g_EVENT_RESP_SECOND_ABILITY_API = "resp_com_ohos_dpmsst_appkit_secondability_ability_api";
// PageAbility: ThirdAbility Constants to use
const std::string g_respPageThirdAbilityST = "resp_com_ohos_dpmsst_appkit_third_ability";
const std::string g_requPageThirdAbilityST = "requ_com_ohos_dpmsst_appkit_third_ability";
...
const std::string g_respPageFourthAbilityST = "resp_com_ohos_dpmsst_appkit_fourth_ability";
const std::string g_requPageFourthAbilityST = "requ_com_ohos_dpmsst_appkit_fourth_ability";
...
const std::string g_respPageSixthAbilityST = "resp_com_ohos_dpmsst_appkit_sixth_ability";
const std::string g_respPageSixthAbilityLifecycleCallbacks = "resp_sixth_ability_lifecycle_callback";
const std::string g_requPageSixthAbilityST = "requ_com_ohos_dpmsst_appkit_sixth_ability";
...
const std::string g_respPageManagerAbilityST = "resp_com_ohos_dpmsst_appkit_manager_ability";
const std::string g_requPageManagerAbilityST = "requ_com_ohos_dpmsst_appkit_manager_ability";
...
const std::string g_respPageManagerSecondAbilityST = "resp_com_ohos_dpmsst_appkit_manager_second_ability";
const std::string g_requPageManagerSecondAbilityST = "requ_com_ohos_dpmsst_appkit_manager_second_ability";
...
const std::string g_EVENT_REQU_FIFTH = "requ_com_ohos_dpmsst_appkit_fifth";
const std::string g_EVENT_RESP_FIFTH = "resp_com_ohos_dpmsst_appkit_fifth";
