...
#ifndef DPMS_ST_SERVICE_ABILITY_A1_
#define DPMS_ST_SERVICE_ABILITY_A1_
#include <string>
#include <map>
...
const std::string APP_A1_RESP_EVENT_NAME = "resp_com_ohos_dpmsst_service_app_a1";
const std::string APP_A1_REQ_EVENT_NAME = "req_com_ohos_dpmsst_service_app_a1";

class DpmsStServiceAbilityA1 : public Ability {
public:
    ~DpmsStServiceAbilityA1();
...
private:
    ...
    typedef void (DpmsStServiceAbilityA1::*func)();
    ...
    public:
        ...
        DpmsStServiceAbilityA1 *mainAbility_ = nullptr;
    };
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // DPMS_ST_SERVICE_ABILITY_A1_