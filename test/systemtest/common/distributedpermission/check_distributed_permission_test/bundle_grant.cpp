...
class BundleGrantTest : public testing::Test {
public:
...
void BundleGrantTest::SetUpTestCase(void)
{}

void BundleGrantTest::TearDownTestCase(void)
{}

void BundleGrantTest::SetUp(void)
{}

void BundleGrantTest::TearDown(void)
{}
 ...
 */
HWTEST_F(BundleGrantTest, DPMS_BundleGrant_0100, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "BundleGrantTest DPMS_BundleGrant_0100 start";
    ...
    GTEST_LOG_(INFO) << "BundleGrantTest DPMS_BundleGrant_0100 end";
}