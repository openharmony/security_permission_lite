...
#ifndef REQUEST_REMOTE_PERMISSION_COMMAND_TEST_H
#define REQUEST_REMOTE_PERMISSION_COMMAND_TEST_H
...
public:
    ...
    void SetUp();
    void TearDown();
    const std::unique_ptr<RequestRemotePermissionCommand> GetClass() const;
};
}  // namespace Permission
}  // namespace Security
}  // namespace OHOS
